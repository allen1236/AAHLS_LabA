...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			...
			{"Name" : "data_channel121", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "10", "DependentChanType" : "0",
				"SubConnect" : [
...
set Spec2ImplPortList { 
	...
	data_channel121 { ap_fifo {  { data_channel121_dout fifo_port_we 0 32 }  { data_channel121_num_data_valid fifo_status_num_data_valid 0 5 }  { data_channel121_fifo_cap fifo_update 0 5 }  { data_channel121_empty_n fifo_status 0 1 }  { data_channel121_read fifo_data 1 1 } } }
